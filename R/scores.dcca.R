...
#' @export
scores.dcca <- function(x, choices=c(1,2), display= c("all"), scaling = "sym", which_cor = "in model", tidy = FALSE,...){
 scores_dcca(x, choices = choices, display = display, scaling = scaling, which_cor = which_cor, tidy= tidy, ...)
}
