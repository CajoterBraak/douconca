...
#' @param which_cor character vector environmental variables names
...
#' @export
scores.wrda <- function(x, choices=c(1,2), display= c("all"), scaling = "sym", which_cor = "in model", tidy = FALSE,...){
